...
public class Controller {
    ...
    @FXML
    private ImageView buttonTriangle;
    @FXML
    private ImageView buttonPolygon;
    @FXML
    private ImageView buttonSpiral;
    @FXML
    private ImageView buttonSquare;
    @FXML
        ...
        switch (selectionFigure.getId()) {
            ...
            case "buttonPolygon":
                ...
                if (pointX.contains(event.getX()) && pointY.contains(event.getY())) {
                    ...
                    polylines.setStroke(colorPicker.getValue());
